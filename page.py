...
class Ui_six_night(object):
    def setupUi(self, six_night):
        ...
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_2.clicked.connect(lambda: self.change_window(promo_window, promo_ui))
    ...
    def change_window(self, window, current_window_ui):           
        ...
        six_night_promo_window.close()
        window.show()

    def mouseDoubleClickEvent(self, e):
        self.pushButton.setText("mouseDoubleClickEvent")
...
"background-color: rgb(245,232,50)")
        self.bonus_night.clicked.connect(lambda: self.change_window(six_night_promo_window, six_night_promo_ui))
...
if __name__ == "__main__":
    ...
    ##Шестая ночь##
    ###############
    six_night_promo_window = QtWidgets.QMainWindow()
    six_night_promo_ui = Ui_six_night()
